...
updated_at: '2026-07-27T12:25:47+00:00'
scope:
  include:
...
- id: T-006
  ...
  depends_on:
  - T-005
  note: Running role-isolated artifact/evidence audit before setting the exact 1.0
    cachebuster and creating the bounded implementation commit.
- id: T-007
