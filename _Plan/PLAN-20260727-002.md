...
updated_at: '2026-07-27T12:51:42+00:00'
scope:
  include:
...
- id: T-007
  ...
  note: 'Preflight repair authorized by user: controlled AGENTS.md legacy marker committed
    as 4e249f7; authentic T-004-validation.md restored byte-identically with recorded
    SHA256 24772010b8f98cbf92329b6f6ca5d4223fb88d9573f1e1afb31f320705001f1b. Corrected
    temporary-copy migration preflight now fails closed on the next unscoped missing
    input evidence:.logs/PLAN-20260727-001/T-005-live-activation.md. Its matching
    original exists in the retained task-completion-reporting worktree but was not
    copied because authorization covered only T-004. C-LIVE-SWITCH remains pending
    and no live install or migration ran.'
validations:
- id: V-001
