...
updated_at: '2026-07-27T15:54:20+00:00'
scope:
  include:
...
- id: T-007
  ...
  note: C-LIVE-SWITCH is accepted; T-008 cleared marker/root-Plan hardcoding. Activate
    exact RC work-governance@1.0.0-rc.1+codex.20260727153740 and validate only in
    a fresh session before any formal version.
- id: T-008
  ...
  - A-004
  - A-007
  note: Verified by implementation commit 7db2497, exact RC work-governance@1.0.0-rc.1+codex.20260727153740,
...
- id: A-001
  ...
  state_changed_at: '2026-07-27T13:27:59+00:00'
- id: A-002
...
activation:
  ...
  target_ref: work-governance@1.0.0-rc.1+codex.20260727153740
  confirmation_id: C-LIVE-SWITCH
  decision_ref: user:2026-07-27-recommended-rc-flow
route:
  route_status: active
  slice_status: executing
  next_phase: Install the exact RC, open a fresh session, adopt the bound legacy snapshot,
    and validate self-hosted migration before assigning the formal version.
...
handoff:
  route_status: active
  next_step: Install work-governance@1.0.0-rc.1+codex.20260727153740 from commit 7db2497
