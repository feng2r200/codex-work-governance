...
updated_at: '2026-07-27T13:28:00+00:00'
scope:
  include:
...
- id: T-007
  ...
  note: 'Live switch paused: user rejected the temporary AGENTS.md legacy marker and
    requested removal of all equivalent forced authority hardcoding before rebuilding
    the 1.0 candidate.'
validations:
- id: V-001
