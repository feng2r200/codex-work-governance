...
updated_at: '2026-07-28T04:05:32+00:00'
scope:
  include:
...
- id: T-005
  ...
  depends_on:
  - T-004
  note: Run the exact failure-derived probe, full validation, artifact review, cachebuster
    update, exact-path local commit and local-main integration; keep live activation
    and Push untouched.
- id: T-006
