...
updated_at: '2026-07-28T04:14:19+00:00'
scope:
  include:
...
activation:
  ...
  target_ref: work-governance@1.0.2+codex.20260728034709
  confirmation_id: C-LIVE-SWITCH-1-0-2
route:
  route_status: awaiting_confirmation
  slice_status: local-delivery-complete
  next_phase: Decide whether to activate the exact 1.0.2 candidate and run the live
    target-project migration.
  validation_standard: A fresh session loads the exact candidate, the target project
    reaches READY after the bounded migration path, and Plan authority remains worktree-local.
  confirmation_gate: C-LIVE-SWITCH-1-0-2
handoff:
  route_status: awaiting_confirmation
  next_step: Await C-LIVE-SWITCH-1-0-2 before reinstalling the Plugin or mutating
    PharmaceuticalGroup.
---
