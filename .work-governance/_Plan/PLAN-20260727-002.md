...
updated_at: '2026-07-27T17:52:28+00:00'
scope:
  include:
  ...
  - Release 1.0.1 with a real-path bootstrap recovery for the observed layout-versus-Plan
    deadlock and complete exact-build blocked receipts.
  - Make goal anchoring, early safe real probes, evidence-delta loop stop-loss, root-cause
    and solution challenge, and evidence-provenance test selection enforceable lifecycle
    behavior; do not optimize for exhaustive or invented test coverage.
  exclude:
...
- id: T-010
  ...
  resolves_artifacts:
  - A-007
  note: 'Formal 1.0.0 SessionStart exposed a dual-axis deadlock: layout validate rejects
    a suspect Plan artifact before the recovery task can restore it. The committed-layout
    failure path also omits exact blocked-receipt provenance. Continue only through
    the separately authorized 1.0.1 recovery task.'
- id: T-011
  description: Release 1.0.1 by separating layout structural validity from Plan operational
    artifact blocking, preserving complete exact-build blocked receipts, and adding
    an enforceable goal-first, reality-probe, ineffective-loop stop-loss, root-cause,
    alternative-solution, and test-provenance contract; validate it on the observed
    suspect-artifact SessionStart path and isolated worktrees, integrate code without
    overwriting main Plan state, reinstall locally, and recover the main route without
    AGENTS.md overrides or Push.
  status: in_progress
  completion_scope: route
  depends_on:
  - T-009
  ...
  - A-005
  - A-007
  note: Started from an exact formal 1.0.0 READY receipt in this isolated worktree.
    First implementation slice targets the observed suspect-artifact SessionStart
    deadlock and committed-layout receipt provenance; broad tests are deferred until
    the smallest real boundary probe changes evidence.
validations:
- id: V-001
...
- id: A-001
  ...
  status: suspect
  evidence_ref: evidence:.work-governance/logs/PLAN-20260727-002/T-007-operational-reference-resolution.md
  evidence_sha256: e4a68560346cf254313ad467f290b2136c2b9a33e398fe197544c08efc2a0170
  finalized_at: '2026-07-27T16:49:17+00:00'
  state_evidence_ref: evidence:.work-governance/logs/PLAN-20260727-002/T-011-observed-root-cause.md
  state_evidence_sha256: 971157ef54e107df208e12f5a81704f341c9d70d17c313b115ef860b88dc7487
  state_changed_at: '2026-07-27T17:52:26+00:00'
- id: A-002
  path: plugins/work-governance/hooks
  status: suspect
  evidence_ref: evidence:.work-governance/logs/PLAN-20260727-002/T-008-rc-validation.md
...
- id: A-003
  ...
  state_evidence_ref: evidence:.work-governance/logs/PLAN-20260727-002/T-011-observed-root-cause.md
  state_evidence_sha256: 971157ef54e107df208e12f5a81704f341c9d70d17c313b115ef860b88dc7487
  state_changed_at: '2026-07-27T17:52:27+00:00'
- id: A-004
  path: tests
  status: suspect
  evidence_ref: evidence:.work-governance/logs/PLAN-20260727-002/T-007-operational-reference-resolution.md
...
- id: A-007
  ...
  state_evidence_ref: evidence:.work-governance/logs/PLAN-20260727-002/T-011-observed-root-cause.md
  state_evidence_sha256: 971157ef54e107df208e12f5a81704f341c9d70d17c313b115ef860b88dc7487
  state_changed_at: '2026-07-27T17:52:28+00:00'
- id: A-008
...
activation:
  status: active
  current_ref: work-governance@1.0.0-rc.1+codex.20260727164238
  target_ref: work-governance@1.0.0-rc.1+codex.20260727164238
  confirmation_id: C-LIVE-SWITCH
  decision_ref: user:2026-07-27-recommended-rc-flow
  evidence:
    observed_ref: work-governance@1.0.0-rc.1+codex.20260727164238
    source_ref: evidence:.work-governance/logs/PLAN-20260727-002/T-007-self-host-migration-validation.md
    checked_at: '2026-07-28T01:01:45+08:00'
    sha256: 81a7bafbe28f138d2e926dc9143a8338c2e6e9c1f2470f2bc6c426823bf41719
route:
  route_status: active
  slice_status: initialized
  next_phase: Execute T-011 in the isolated .work-governance/worktrees/work-governance-1.0.1
    worktree, starting with the observed SessionStart failure combination and the
    smallest real boundary probe.
  validation_standard: The actual suspect-artifact SessionStart path must stay LAYOUT_READY
    while Plan recovery remains explicit; blocked receipts must retain exact provenance;
    the lifecycle contract must stop evidence-free loops and reject invented coverage
    work; worktree isolation, source/cache equality, local installation, fresh-session
    recovery, and no Push must be proven.
  confirmation_gate: none
handoff:
  route_status: active
  next_step: Start T-011 under the current explicit user authorization and perform
    the observed failure-path probe before broad regression expansion.
---
